  ...
  return (
    <div className="mb-16 md:mb-20">
      <div className="mb-8 md:mb-10">
        ...
        <h2 className="font-display text-2xl font-semibold text-text-heading sm:text-3xl">Our Approach</h2>
      </div>
      ...
      <RevealGroup className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
        {steps.map((step, i) => (
          ...
          >
            ...
            <h3 className="mb-3 text-[15px] font-extrabold leading-snug text-text-heading">{step.title}</h3>
