...
const ROLES: Role[] = [
  ...
  },
  {
    ...
    achievements: [
      ...
      "Converted Figma designs and product requirements into pixel-accurate, responsive, and production-ready web interfaces for IoT and connected-product solutions.",
      "Developed reusable UI components for IoT dashboards, device management, monitoring, configuration, and operational workflows.",
      "Built state-driven interfaces representing real-world device conditions such as Online, Offline, Active, Inactive, Warning, Error, and Maintenance.",
      "Developed interactive dashboards for visualizing device status, telemetry, alerts, system health, and real-time IoT data.",
      "Implemented complete UI states including loading, empty, success, error, disabled, hover, selected, and confirmation states to deliver production-ready user experiences.",
      "Collaborated with UI/UX designers, backend developers, and IoT engineers throughout the development lifecycle, from Figma handoff to production deployment.",
    ],
